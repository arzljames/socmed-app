...
const FeedSkeletal = (): JSX.Element => {
  return (
    <>
      ...
      {_.map(Array(3), (_item: any, key: number) => {
        return (
          <div
            key={key}
            ...
            <div className="flex px-3 md:px-6">
              ...
              <div className="0 mb-4 flex flex-1 flex-col ">
                <div className="mb-4 flex flex-col justify-center">
                  <div className="mb-2 h-2 w-10 rounded-full bg-slate-200"></div>
                  <div className="h-2 w-20 rounded-full bg-slate-200"></div>
                </div>
              </div>
            </div>
            <div className="mb-2  px-3 md:px-6">
              <div className="mb-3 flex h-4 rounded-full bg-slate-200 px-3 md:px-6"></div>
              <div className="mb-3 flex h-4 rounded-full bg-slate-200 px-3 md:px-6"></div>
              <div className="mb-3 flex h-3 w-3/4 rounded-full bg-slate-200 px-3 md:px-6"></div>
            </div>
          </div>
        );
      })}
